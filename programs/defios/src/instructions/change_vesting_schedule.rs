...
use crate::state::{Repository,VestingSchedule,Schedule,VestingScheduleChanged};
#[derive(Accounts)]
...
pub fn handler(ctx: Context<AdminVestingScheduleShift>, new_vesting_schedule:Vec<Schedule>) -> Result<()> {
