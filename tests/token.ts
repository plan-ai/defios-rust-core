...
describe("defios", async () => {
  ...
  const wallet = Keypair.fromSecretKey(
    Uint8Array.from([
      183, 17, 185, 36, 109, 137, 119, 166, 151, 221, 22, 157, 213, 239, 184,
      72, 165, 20, 132, 67, 193, 94, 137, 94, 37, 41, 156, 148, 58, 103, 129,
      170, 50, 29, 169, 61, 98, 171, 169, 99, 50, 188, 34, 236, 197, 52, 74,
      184, 177, 137, 205, 151, 169, 3, 236, 213, 193, 129, 38, 138, 170, 184,
      131, 102,
    ])
  );
  const { web3 } = anchor;
